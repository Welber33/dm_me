...
export function GroupChatModal({ isOpen, onClose, users }: GroupChatModalProps) {
  ...
  async function onCreateGroupChat(data: FieldValues) {
    setIsLoading(true);
    ...
    await axios.post('/api/conversations', {
      ...
      .catch(() => {
        toast.error('Something went wrong on Group Chat Modal')
      })
  ...
  return (
    <Modal
      ...
      onClose={onClose}
    >
      <form onSubmit={handleSubmit(onCreateGroupChat)}>
        <div className="space-y-12">
          <div className="border-b border-silvergray-700/10 pb-12">
            ...
            <p className="mt-1 text-sm leading-6 text-silvergray-600">
              Create a chat with more than 2 users
            </p>
